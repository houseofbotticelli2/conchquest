...
- [ ] #47 Build admin/moderation console (PRD MVP item; should also include OpenAI usage/spend monitoring for #67 once built; needs a content-report/block-user mechanism to satisfy #75's Apple guideline 1.2 requirement)
