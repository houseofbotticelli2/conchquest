  ...
  return (
    <Modal visible={visible} transparent animationType="fade" onRequestClose={onClose} onDismiss={onDismiss}>
      <View style={styles.overlay}>
        ...
        <View style={[styles.card, { backgroundColor: t.surfaceCardHi, borderColor: t.borderSoftAlpha }, t.shadowOverlay]}>
...
const styles = StyleSheet.create({
  ...
  title: { fontFamily: fonts.display, fontSize: 17, textAlign: 'center', paddingTop: 20, paddingHorizontal: 20 },
